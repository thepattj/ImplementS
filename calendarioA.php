...
<head>
    ...
    <link rel="stylesheet" href="js/calender/stylecalendar.css">

    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Calendario de Actividades | ImplementS</title>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="">
                        <!-- <p>Actividades que se tienen planeadas para la estación.</p> -->
...
. All rights reserved. ENERGAS S.A de C.V.<a href="https://colorlib.com"></a>.</p>
              ...
              <table style="white-space: nowrap; width: 100%">
                <tr>
                  <td style="text-align: left;">
                    <!-- PARA RECORRER LOS MESES -->
                    <span class="btn-group">
                      <button class="js-cal-prev btn btn-default">&lt;</button>
                      <button class="js-cal-next btn btn-default">&gt;</button>
                    </span>

                    <!-- BOTON PARA VER EL DIA DE HOY -->
                  ...
                  <td style="text-align: right">
                    <span class="btn-group">
                      <!-- BOTONES DE DIFERENTES ORGANIZACIONES -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="calendar-day {{: dayclass }} {{: thedate.toDateCssClass() }} {{: date.toDateCssClass() === thedate.toDateCssClass() ? 'selected':'' }} {{: daycss[i] }} js-cal-option" data-date="{{: thedate.toISOString() }}">
              <div class="date">{{: thedate.getDate() }} <!-- NUMERO DEL MES --> </div>
              {{ thedate.setDate(thedate.getDate() + 1);}} <!-- AQUI ES EL ESPACIO -->
            </td>
            {{ } }}
          </tr>
          {{ } }}
    ...
    <script src="js/calender/index.js"></script>
