...
<head>
    ...
    <title>Auditoria | ImplementS</title>
...
<body id="" style="background-image:url('images/backgroundp.png'); background-repeat: no-repeat; background-position: center; background-size: cover;">
    ...
    <div class="header-top-area" style="background: transparent; !important">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="background:rgb(102,103,102); border-bottom-right-radius: 50px;"><H1 id="usuario" style="color:white; "> Punto 15 </H1></div>
                    ...
                    <div class="col-lg-10 col-md-8 col-sm-8 col-xs-8" >
                        <div class="form-element-list" style="display:; border-radius: 35px;">
                            ...
                            <div class="row" style="border: black 1px solid; display: ;" id="audi">
                                        ...
                                        <label> 
                                            <div class="form-group nk-datapk-ctm form-elet-mg" id="data_1">
                                                <div class="input-group date nk-int-st">
                                                    ...
                                                    <input type="text" class="form-control" id="fechaAud" value="03/19/2018">
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">                                   
                                    <button id="pdfpAuditoria" style="background: #FF5722; color:white;" class="btn btn-deeporange">Descargar</button>
                                </div>
                            </div>
                            ...
                            <div class="row" style="border: black 1px solid; display: none;" id="repaudi" >
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">                                   
                                    <button id="pdfrAuditoria" style="background: #FF5722; color:white;" class="btn btn-deeporange">Descargar</button>
                                </div>
                            </div>                            
                        </div>
                    </div>
