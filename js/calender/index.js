...
.done(function(msg) {
  //alert(msg);       
  localStorage.setItem("datoF",msg);
})
...
var data = [],
    ...
    names = ['abeja', 'act 2', 'cosa 3', 'las 4 palabras', '', 'AQUI ESTA LA SEGUNDA', '', '', 'Actividad ...'],
    slipsum = ["DETALLE 1", "DETALLE 2", "DETALLE 3", "DETALLE 4", "DETALLE 5", "DETALLE 6", "DETALLE 7", "DETALLE 8", "DETALLE 9", "DETALLE ..."];
  ...
  data.push({ title: names[0 % names.length], start: new Date(y, m, d, 10, 33), end: end, allDay: !(15 % 7), text: slipsum[9 % slipsum.length ]  });
  data.push({ title: names[5 % names.length], start: new Date(y, m, 22, 13, 10), end: end, allDay: !(15 % 7), text: slipsum[2 % slipsum.length ]  });
