...
<head>
    <!-- STYLESHEET DIAGRAMA -->
    <link rel="stylesheet" type="text/css" href="js/gantt/js/jquery-ui-1.8.4.css" />
    <link rel="stylesheet" type="text/css" href="js/gantt/reset.css" />
    <link rel="stylesheet" type="text/css" href="js/gantt/jquery.ganttView.css" />
    <style type="text/css">
        body {
    ...
    <title>Programa de implementación | ImplementS</title>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Programación de implementación</h2>
...
. All rights reserved. ENERGAS S.A de C.V.<a href="https://colorlib.com"></a>.</p>
    ...
    <!-- DIAGRAMA DE GANNT -->
    <script type="text/javascript" src="js/gantt/js/jquery-1.4.2.js"></script>
    <script type="text/javascript" src="js/gantt/js/date.js"></script>
            ...
            $("#ganttChart").ganttVie({ 
                ...
                behavior: {
                    ...
                    onDrag: function (data) { 
                        var msg = "You dragged an MOVER: { start: " + data.start.toString("M/d/yyyy") + ", end: " + data.end.toString("M/d/yyyy") + " }";
                        $("#eventMessage").text(msg);
                    }
                }
            });
